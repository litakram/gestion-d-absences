<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Search Bar -->
            <div class="mb-6">
                <form action="{{ route('absences.index') }}" method="GET" class="flex gap-2">
                    <input 
                        type="text" 
                        name="search" 
                        value="{{ request('search') }}" 
                        placeholder="Rechercher par ID, étudiant, date ou séance..."
                    ...
                    @if(request('search'))
                        <a href="{{ route('absences.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-6 rounded-md">
                            Réinitialiser
                        </a>
                    @endif
                </form>
